...
#12.Bir sayının hem 8’e hem de 16’e tam bölünüp bölünmediğini kontrol eden program
sayi = int(input("Bir sayı girin: "))
bolunur_mu = (sayi % 8 == 0) and (sayi % 16 == 0)
print("Sayı hem 3'e hem de 6'e tam bölünüyor mu?", bolunur_mu)